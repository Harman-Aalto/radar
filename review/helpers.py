...
def build_clusters(task_state: dict, course_key: str) -> list[dict]:
    ...
    for cluster in clusters:
        for other_cluster in clusters:
            ...
            if (
                cluster["students"] != other_cluster["students"]
                and len(cluster["students"].intersection(other_cluster["students"])) > 0
            ):
                # Merge the clusters
                ...
                while other_cluster in clusters:
    ...
    for cluster in clusters:
        for other_cluster in clusters:
            ...
            if (
                ...
                and len(cluster.intersection(other_cluster)) > 0
            ):
